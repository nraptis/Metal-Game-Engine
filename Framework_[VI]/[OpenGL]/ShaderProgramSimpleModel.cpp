...
void ShaderProgramSimpleModel::ArrayBufferPositions(int pIndex, int pOffset) {
...
void ShaderProgramSimpleModel::ArrayBufferTextureCoords(int pIndex, int pOffset) {
