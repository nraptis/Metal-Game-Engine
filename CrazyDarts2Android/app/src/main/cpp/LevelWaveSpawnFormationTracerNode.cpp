...
LevelWaveSpawnFormationTracerNode *LevelWaveSpawnFormationTracerNode::Clone(LevelWaveSpawnFormationTracer *pTracer) {
    
    LevelWaveSpawnFormationTracerNode *aClone = new LevelWaveSpawnFormationTracerNode(pTracer);
